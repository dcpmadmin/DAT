      ...
      <div className="space-y-2">
        {hasSubmittedDetails ? (
          <div className="rounded-md border bg-muted/30 p-2">
            <div className="text-xs font-medium text-muted-foreground mb-1">Submitted Damage Details</div>
        ...
        <div className="rounded-md border bg-muted/20 p-2 text-xs">
          <div className="text-muted-foreground font-medium mb-1">Assessment Details</div>
        ...
        {evidenceSummary && (
          <div className="rounded-md border bg-muted/20 p-2 text-xs">
            <div className="text-muted-foreground font-medium mb-1">Evidence Checklist</div>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              <div className="flex items-center gap-1">
                <span className={evidenceSummary.hasDamage ? 'text-green-600' : 'text-red-600'}>
                  {evidenceSummary.hasDamage ? '✓' : '✕'}
                </span>
                <span>Damage photos</span>
              </div>
              <div className="flex items-center gap-1">
                <span className={evidenceSummary.hasPrecondition ? 'text-green-600' : 'text-red-600'}>
                  {evidenceSummary.hasPrecondition ? '✓' : '✕'}
                </span>
                <span>Precondition photos</span>
              </div>
              <div className="flex items-center gap-1">
                <span className={evidenceSummary.hasCompletion ? 'text-green-600' : 'text-red-600'}>
        ...
        {folderSummary && (
          <div className="rounded-md border bg-muted/20 p-2 text-xs">
            <div className="text-muted-foreground font-medium mb-1">Asset Summary</div>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              <div>
        ...
        {photoSummaries && photoSummaries.length > 0 && (
          <div className="rounded-md border bg-muted/20 p-2 text-xs">
            <div className="text-muted-foreground font-medium mb-1">Photo Timeline</div>
